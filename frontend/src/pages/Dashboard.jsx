  ...
  return (
    <>
      <div className='flex w-full min-h-screen'>
        ...
        <div className='flex flex-col h-full w-[80%] rounded-md'>
          <div className='navbar flex w-full justify-between items-center'>
            ...
            <div className='flex w-1/2 justify-evenly py-1 items-center'>
              <Link to="/upload-file">
          ...
          <div className='main flex rounded-2xl justify-between bg-sky-100 px-10 py-5'>
