    ...
    <>
      <div className='flex w-full min-h-screen gap-5'>
        ...
        <div className='flex flex-col h-full w-[80%] bg-zinc-100 py-1 rounded-md'>
          ...
          <div className='main flex p-5 rounded-xl'>
            <div className='flex flex-col w-2/3 px-15 gap-3 h-full'>
              <div className='progressCard text-white bg-sky-500 w-[70%] h-60 flex justify-around px-2 items-center border-gray-800 rounded-xl'>
                <div style={{
                  height:"10rem",
                  width:"10rem",
                }}>
              ...
              <div className='flex gap-2 flex-wrap h-full w-full'>
                <div className='w-50 h-35 border rounded-md'></div>
                <div className='w-50 h-35 border rounded-md'></div>
                <div className='w-50 h-35 border rounded-md'></div>
                <div className='w-50 h-35 border rounded-md'></div>
              </div>
