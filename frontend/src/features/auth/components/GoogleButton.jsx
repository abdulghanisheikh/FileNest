...
const GoogleButton = () => {
  return (
    <a href='http://localhost:3000/auth/google' className="bg-[linear-gradient(#e9e9e9,#e9e9e9_50%,#fff)] group inline-flex transition-all duration-300 overflow-visible py-1 px-5 w-fit ml-16 rounded-full">
      ...
      <div className="w-half h-full bg-[linear-gradient(to_top,#ececec,#fff)] overflow-hidden shadow-[0_0_1px_rgba(0,0,0,0.07),0_0_1px_rgba(0,0,0,0.05),0_3px_3px_rgba(0,0,0,0.25),0_1px_3px_rgba(0,0,0,0.12)] rounded-full hover:shadow-none duration-300">
        ...
        <div className="w-full h-full gap-x-0.5 gap-y-0.5 justify-center text-[#101010] bg-[linear-gradient(#f4f4f4,#fefefe)] group-hover:bg-[linear-gradient(#e2e2e2,#fefefe)] duration-200 items-center font-medium gap-4 inline-flex overflow-hidden px-4 py-0.5 rounded-full black group-hover:text-blue-600">
          ...
          <span className="ml-2 lg:text-[15px] text-xs">Continue with Google</span>
        </div>
      </div>
    </a>
  );
