...
const FileUpload = () => {
    ...
    return (
        <div className='flex flex-col gap-5 relative justify-center items-center main h-screen w-full bg-zinc-100 p-10'>
            ...
            <form onSubmit={() => handleUploadFile({file})} encType="multipart/form-data" className='flex border-b-4 border-r-4 border-b-black/20 border-r-black/20 flex-col duration-300 ease-linear justify-center align-center gap-2 items-center h-60 w-120 bg-white rounded-3xl p-5'>
                <label
