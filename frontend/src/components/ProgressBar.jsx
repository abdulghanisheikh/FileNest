...
const ProgressBar=({usedStorage})=>{
    ...
    return(
      <div className='progressCard text-white bg-gradient-to-r from-blue-500 to-indigo-600   w-full h-50 flex justify-around px-2 py-3 items-center border-gray-800 rounded-xl'>
          <div style={{
              height:"10rem",
              width:"10rem",
          }}>
