...
const Navbar=({query,setQuery})=>{
  return(
    <div className='navbar flex w-full py-4 rounded-md px-5 justify-between items-center gap-2'>
        <input className='h-10 w-1/2 shadow-sm shadow-black/10 rounded-full outline-none bg-white px-5' type="text" placeholder="search" name="search" onChange={(e)=>setQuery(e.target.value)} value={query} />
